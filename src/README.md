...
the header and footer. It declares with `ngApp` that this is `angular-introduction`,
...
"angular-introduction" will rename the resultant CSS and JavaScript placed in `build/`,
